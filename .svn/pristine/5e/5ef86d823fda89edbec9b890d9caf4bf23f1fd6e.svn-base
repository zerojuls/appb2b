        ...
        <div class="row-fluid">
            ...
            <div class="span6" style="border-left: 1px solid #DDDDDD !important; margin-top: -30px;">
                ...
                ?>
                    ...
                    <div class="row-fluid fluid " style="margin-top: -15px">
                        ...
                        <div class="span6">
                            ...
                            <div class="row-fluid fluid modal-float">
                                ...
                                <div id="txt_d_unidad" name="txt_d_unidad" class="span6" ><h3><?php if (isset($txt_d_unidad)) echo $txt_d_unidad ?></h3></div>
                            </div>
                        </div>
                        <div class="span6">
                            <div id="txt_precio" name="txt_precio"><h1 class="full value green"><b> S/. <?php if (isset($txt_precio)) echo $txt_precio ?></b></h1></div>
                    ...
                    <button id="submit"  class="btn btn-info btn-large btn-block well pagination-centered paint color_19" type="button">Añadir al carrito</button>
                    <h3>Descripcion:</h3>
                    <blockquote>
...
$(document).ready(function(){
    ...
    $('#submit').on('click', (function(){
        ...
        $.ajax({
            ...
            dataType: "html",
            data: datos,
            url: "<?php echo base_url('pedido/add_pedido'); ?>",
            beforeSend: function(){
                $("#submit").attr("disabled", "disabled");
                $("#submit").html("Procesando ...");
            },
            ...
            error: function() {
                jAlert('Surgió un error al guardar el producto!', TituloInformacion);
                $("#submit").removeAttr("disabled");
                $("#submit").html("Añadir al carrito");
            },
            complete: function(){
                getMontoCompra();
            }
