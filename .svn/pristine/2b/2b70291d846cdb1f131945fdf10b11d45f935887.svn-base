...
<div class="box color_light">
    <div class="modal-header " >
        ...
        <h4> <i class="icon-book"></i>
            <span>Detalle de Producto Pedido</span> 
        </h4>
    </div>
    <div class="modal-body">
        <div class="row-fluid">
            <div class="span6"><img src="<?= base_url('img/galeria_productos/')?>/<?php if (isset($txt_c_producto)) echo $txt_c_producto ?>.png "></div>
            <div class="span6" style="border-left: 1px solid #DDDDDD !important; margin-top: -30px;">
                <form id="frmNew" action="<?= base_url('pedido/upd_pedido') ?>" method="POST" class="form-horizontal row-fluid">
                    <br>
                    ...
                    <div class="row-fluid fluid " style="margin-top: -15px">
                        <div class="controls hide"><input type="text" class="hide" id="txt_id_pedido_detalle" name="txt_id_pedido_detalle" value="<?php if (isset($txt_id_pedido_detalle)) echo $txt_id_pedido_detalle ?>"></div>
                        <div class="controls hide"><input type="text" class="hide" id="txt_id_pedido" name="txt_id_pedido" value="<?php if (isset($txt_id_pedido)) echo $txt_id_pedido ?>"></div>
                        ...
                        <div class="span6">
                            ...
                            <div class="form-row control-group row-fluid fluid">
                                <span class="row-fluid k-textbox">
                                    <input type="number" data-role="numerictextbox" id="txt_cantidad" class="row-fluid " name="txt_cantidad" value="<?php if (isset($txt_cantidad)) echo $txt_cantidad ?>" style="border: 1px solid #CCCCCC;text-align: right;">
                                </span>
                            </div>
                        </div>
                    </div>
                    <button id="submit"  class="btn btn-info btn-large btn-block well pagination-centered paint color_19" type="submit">Modificar cantidad</button>
                    <h3>Descripcion:</h3>
                    <blockquote>
